		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try 
				{
					...
					String query = "SELECT * FROM kelas_bumi";
					JDBCCategoryDataset data = new JDBCCategoryDataset("jdbc:mysql://localhost/pajak","com.mysql.jdbc.Driver","root","");
					data.executeQuery(query);
					JFreeChart chart = ChartFactory.createLineChart("Index Jual Bumi","Jenis", "Jual", data,PlotOrientation.VERTICAL,true, true, false);
